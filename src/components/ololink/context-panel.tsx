    ...
    <AnimatePresence>
      {id && Body && item && (
        <motion.aside
          ...
          className="pointer-events-auto absolute bottom-3 left-3 top-16 z-20 flex w-[336px] flex-col overflow-hidden rounded-2xl border border-white/20 bg-white/15 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.45)] backdrop-blur-2xl backdrop-saturate-150"
        >
